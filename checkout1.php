                ...
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td><?php echo LANG_VALUE_0 . $_SESSION['cart_p_current_price'][$key]; ?></td>
                            <td><?php echo $_SESSION['cart_p_qty'][$key]; ?></td>
                            <td class="text-right"><?php echo LANG_VALUE_0 . $row_total_price; ?></td>
                        </tr>
                        <?php } ?>

                        <tr>
                            <th colspan="7" class="total-text"><?php echo LANG_VALUE_81; ?></th>
                            <th class="total-amount"><?php echo LANG_VALUE_0 . $table_total_price; ?></th>
                        </tr>
                        <tr>
                            <td colspan="7" class="total-text"><?php echo LANG_VALUE_84; ?></td>
                            <td class="total-amount"><?php echo LANG_VALUE_0 . '0.00'; ?></td>
                        </tr>
                        <tr>
